...
//     useDocTitle('Solicita una cotización | CommunityTech');
...
//                             <div className="flex">
//                                 <h1 className="font-bold text-center lg:text-left text-purple-900 uppercase text-4xl">Solicita una cotización</h1>
//                             </div>
...
//                                  />
//                                 <label htmlFor="checkbox-1" className="ml-3 text-lg font-medium text-gray-900">Telemarketing</label>
//                             </div>
//                             <div className="flex items-center my-4">
//                                 <input 
//                                     id="checkbox-1" 
...
//                                     />
//                                 <label htmlFor="checkbox-1" className="ml-3 text-lg font-medium text-gray-900">SMS</label>
//                             </div>
//                             <div className="flex items-center my-4">
//                                 <input 
//                                     id="checkbox-1" 
...
//                                 />
//                                 <label htmlFor="checkbox-1" className="ml-3 text-lg font-medium text-gray-900">Email</label>
//                             </div>
//                             <div className="flex items-center my-4">
//                                 <input 
//                                     id="checkbox-1" 
...
//                                 />
//                                 <label htmlFor="checkbox-1" className="ml-3 text-lg font-medium text-gray-900">Redes sociales</label>
//                             </div>
//                             {errors && 
...
//                             <button type="submit" id="submitBtn" className="uppercase text-sm font-bold tracking-wide bg-purple-900 hover:bg-purple-800 text-gray-100 p-3 rounded-lg w-full 
...
//                                     <p className="text-gray-400">30 N Gould St #45376, Sheridan, WY 82801</p>
//                                 </div>
//                             </div>
...
//                                 <div className="flex flex-col">
//                                     <h2 className="text-2xl">Llámenos</h2>
//                                     <p className="text-gray-400">(315) 270-3804</p>
                                
//                                     <div className='mt-5'>
//                                         <h2 className="text-2xl">Envía un E-mail</h2>
...
const Contact = () => {
    useDocTitle('Contáctanos | CommunityTech');
    const [firstName, setFirstName] = useState('');
    const [lastName, setLastName] = useState('');
    const [email, setEmail] = useState('');
    const [phone, setPhone] = useState('');
                ...
                <div className="container mx-auto my-8 px-4 lg:px-20" data-aos="zoom-in">
                    <form onSubmit={sendEmail}>
                        <div className="w-full bg-white p-8 my-4 md:px-12 lg:w-9/12 lg:pl-20 lg:pr-40 mr-auto rounded-2xl shadow-2xl">
                            ...
                            <div className="my-2 w-1/2 lg:w-2/4">
                                <button type="submit" id="submitBtn" className="uppercase text-sm font-bold tracking-wide bg-purple-900 hover:bg-purple-800 text-gray-100 p-3 rounded-lg w-full focus:outline-none focus:shadow-outline">
                                    Enviar Mensaje
                                </button>
                            </div>
                        </div>
                    ...
                    <div className="w-full lg:-mt-96 lg:w-2/6 px-8 py-6 ml-auto bg-purple-900 rounded-2xl">
                        <div className="flex flex-col text-white">
                            ...
                            <div className="flex my-4 w-2/3 lg:w-1/2">
                                <a href="https://www.facebook.com/communitytech1" target="_blank" rel="noreferrer" className="rounded-full flex justify-center bg-white h-8 text-purple-900 w-8 mx-1 text-center pt-1">
