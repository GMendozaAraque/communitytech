...
//                         <div className="flex">
//                             <h1 className="font-bold text-center lg:text-left text-purple-900 uppercase text-4xl">Contáctanos</h1>
//                         </div>
...
//                 </form>
//                         <div
//                             className="w-full  lg:-mt-96 lg:w-2/6 px-8 py-6 ml-auto bg-purple-900 rounded-2xl">
